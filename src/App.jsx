            ...
            <div className="container">
              <div className="calculator-grid">
                <aside className="calculator-card glass-card">
                  ...
                  {/* Sponsor Slider Box */}
                  <div className="sidebar-sponsor-box">
                    <div className="ticker-header-mini">
                      <span className="premium-badge">PREMIUM FIRSATLAR</span>
                    </div>
                    <div className="ticker-main">
                      <div className="ticker-row row-right">
                        <div className="ticker-track">
                          <div className="ticker-item">
                            <span>🚀 <b>Katılımevim:</b> Dosya masrafsız ev sahibi olma fırsatı!</span>
                            <div className="sponsor-ad-frame">
                              <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=400&h=200&auto=format&fit=crop" alt="Ad" />
                            </div>
                          </div>
                          <div className="ticker-item">
                            <span>💎 <b>Eminevim:</b> Elbirliği sistemiyle araba sahibi olun.</span>
                            <div className="sponsor-ad-frame">
                              <img src="https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?q=80&w=400&h=200&auto=format&fit=crop" alt="Ad" />
                            </div>
                          </div>
                          <div className="ticker-item">
                            <span>🌟 <b>Fuzul Ev:</b> Çekilişli gruplarda 6. ay teslimat garantisi!</span>
                            <div className="sponsor-ad-frame">
                              <img src="https://images.unsplash.com/photo-1549517045-bc93ee079e33?q=80&w=400&h=200&auto=format&fit=crop" alt="Ad" />
                            </div>
                          </div>
                          {/* Loop content */}
                          <div className="ticker-item">
                      ...
                      <div className="ticker-row row-left">
                        <div className="ticker-track">
                          <div className="ticker-item">
                            <span>🚗 <b>Birevim:</b> Gençlere özel peşinatsız araç finansmanı.</span>
                            <div className="sponsor-ad-frame">
                              <img src="https://images.unsplash.com/photo-1552519507-da3b142c6e3d?q=80&w=400&h=200&auto=format&fit=crop" alt="Ad" />
                            </div>
                          </div>
                          <div className="ticker-item">
                            <span>🏠 <b>Sinpaş:</b> Yapı tasarrufuyla faizsiz konut kredisi.</span>
                            <div className="sponsor-ad-frame">
                              <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?q=80&w=400&h=200&auto=format&fit=crop" alt="Ad" />
                            </div>
                          </div>
                          <div className="ticker-item">
                            <span>🎯 <b>Hedefevim:</b> Planlı tasarrufla geleceğinizi inşa edin.</span>
                            <div className="sponsor-ad-frame">
                              <img src="https://images.unsplash.com/photo-1448630360428-654a65753ec5?q=80&w=400&h=200&auto=format&fit=crop" alt="Ad" />
                            </div>
                          </div>
                          {/* Loop content */}
                          <div className="ticker-item">
                      ...
                      <div className="ticker-row row-right slow">
                        <div className="ticker-track">
                          <div className="ticker-item">
                            <span>📉 <b>Finansevim:</b> Aylık %0.49’dan başlayan!</span>
                            <div className="sponsor-ad-frame">
                              <img src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?q=80&w=400&h=200&auto=format&fit=crop" alt="Ad" />
                            </div>
                          </div>
                          <div className="ticker-item">
                            <span>✅ <b>BDDK ONAYLI:</b> Tüm şirketlerimiz devlet güvencesindedir.</span>
                            <div className="sponsor-ad-frame">
                              <img src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?q=80&w=400&h=200&auto=format&fit=crop" alt="Ad" />
                            </div>
                          </div>
                          <div className="ticker-item">
                            <span>🎁 <b>ENİYİKATILIM:</b> Bugün başvuranlara özel hediye çeki!</span>
                            <div className="sponsor-ad-frame">
                              <img src="https://images.unsplash.com/photo-1513201099705-a9746e1e201f?q=80&w=400&h=200&auto=format&fit=crop" alt="Ad" />
                            </div>
                          </div>
                          {/* Loop content */}
                          <div className="ticker-item">
